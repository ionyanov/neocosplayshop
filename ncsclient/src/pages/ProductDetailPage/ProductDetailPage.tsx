...
const ProductDetailPage: FC = () => {
    ...
    const { data, isLoading } = getProductDetailQuery(id) as ReducerData<Product>;
    if (!id)
        ...
        <Page>
            <Grid container
                ...
                <Grid container
                      ...
                      alignItems='center'
                      width={'50%'}>
                    <BorderedImage content={data.mainimage}
                                   width={300}
                                   height={300}
                                   title={data.name}
                ...
                <Grid container
                    ...
                    <Typography>
                        By making order you agree to our <Link to={getRouteAbout()}>store policy</Link>
                    </Typography>
                </Grid>
            </Grid>
        </Page>
